  ...
  begin
    ...
    have q₁: ∀ B ∈ ∂𝒜' \ ∂𝒜, U ⊆ B ∧ disjoint V B ∧ (B ∪ V) \ U ∈ ∂𝒜 \ ∂𝒜',
      ...
      split,
        ...
        convert q.2.2,
        rw [insert_eq, insert_eq, union_assoc,
            union_sdiff_distrib _ (B ∪ V),
      ...
      rw mem_shadow', rintro ⟨w, a_h_w, a_h_h⟩, by_cases (w ∈ U),
        ...
        have: (insert w ((B ∪ V) \ U) ∪ erase U w) \ erase V z = insert z B,
          rw [insert_union, ← union_insert, insert_erase h,
              ...
              inter_singleton_of_mem Hz, union_comm, ←insert_eq],
        rwa ← this,
      ...
      rw [finset.sdiff_eq_self_iff_disjoint, disjoint_insert_left], split, assumption,
      rwa disjoint.comm,
